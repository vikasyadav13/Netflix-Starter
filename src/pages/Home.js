...
const Home = () => {
  ...
  useEffect(() => {
    async function fetchMyList() {
      await Moralis.start({
        serverUrl: "https://fy67iepfwq7w.usemoralis.com:2053/server",
        appId: "tdZdgZj5l0Fj5kr2dBHAD0fu5wJ4E2y54XiQNSsW",
      });
  ...
  const handleNewNotification = () => {
    dispatch({
      type: "error",
      message: "Plese Connect Your Crypto Wallet",
      title: "Not Authnticated",
      position: "topL"
    })
    ...
    <>
      ...
      <div className='topBanner'>
        <TabList defaultActiveKey={1} tabStyle="bar">
          ...
          <Tab tabKey={2} tabName={"Series"} isDisable={true}></Tab>
          ...
          <div className='title'>
                ...
                <div className='ownThumbs'>
              {
                myMovies.map((e) => {
                 ...
                 <div className="ownThumbs">
                 You Need to Authnticated to view MyList
                 </div>
